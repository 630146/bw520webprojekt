...
<body>
				...
				<div class="menu-bar">
					...
					<ul>
						<li class="active"><i class="fas fa-home"></i> <input
							type="submit" name="startseite" value="Startseite"></li>
	...
	<div class="kasten">
		<div class="dropdown">
			<button onclick="myFunction()" class="dropbtn">Durchsuche
				lazyNerds</button>
			<div id="myDropdown" class="dropdown-content">
				<input type="text" id="myInput" onkeyup="myFunction()"
					placeholder="Durchsuche lazyNerds.." title="Type in a name">

				<ul id="myUL">
					<li><a href="../jsp/PortalAppl.jsp?wi=Wirtschaftsinformatik">Wirtschaftsinformatik</a></li>
					<li><a href="../jsp/PortalAppl.jsp?wi=Wirtschaftsinformatik">Wirtschaftsinformatik
							Skript</a></li>
					<li><a href="../jsp/PortalAppl.jsp?wi=Wirtschaftsinformatik">Wirtschaftsinformatik
							Altklausur</a></li>
					<li><a href="../jsp/PortalAppl.jsp?wi=Wirtschaftsinformatik">Wirtschaftsinformatik
							Prof</a></li>
					<li><a
						href="../jsp/PortalAppl.jsp?abwlbuch=ABWL und Buchfuehrung">ABWL
							und Buchfuehrung</a></li>
					<li><a
						href="../jsp/PortalAppl.jsp?abwlbuch=ABWL und Buchfuehrung">ABWL
							und Buchfuehrung Skript</a></li>
					<li><a
						href="../jsp/PortalAppl.jsp?abwlbuch=ABWL und Buchfuehrung">ABWL
							und Buchfuehrung Altklausur</a></li>
					<li><a
						href="../jsp/PortalAppl.jsp?abwlbuch=ABWL und Buchfuehrung">ABWL
							und Buchfuehrung Prof</a></li>
					<li><a href="../jsp/PortalAppl.jsp?prog1=Prog I">Programmieren
							1</a></li>
					<li><a href="../jsp/PortalAppl.jsp?prog1=Prog I">Programmieren
							1 Skript</a></li>
					<li><a href="../jsp/PortalAppl.jsp?prog1=Prog I">Programmieren
					...
					<li><a href="../jsp/PortalAppl.jsp?wm=Wirtschaftsmathematik">Wirtschaftsmathematik
							Skript</a></li>
					<li><a href="../jsp/PortalAppl.jsp?wm=Wirtschaftsmathematik">Wirtschaftsmathematik
							Altklausur</a></li>
					<li><a href="../jsp/PortalAppl.jsp?wm=Wirtschaftsmathematik">Wirtschaftsmathematik
							Prof</a></li>
					<li><a href="../jsp/PortalAppl.jsp?sk=Social Skills">Social
							Skills</a></li>
					<li><a href="../jsp/PortalAppl.jsp?sk=Social Skills">Social
							Skills Skript</a></li>
					<li><a href="../jsp/PortalAppl.jsp?sk=Social Skills">Social
							Skills Altklausur</a></li>
					<li><a href="../jsp/PortalAppl.jsp?sk=Social Skills">Social
							Skills Prof</a></li>
					...
					<li><a href="../jsp/PortalAppl.jsp?Stat=Statistik">Statistik
							Skript</a></li>
					<li><a href="../jsp/PortalAppl.jsp?Stat=Statistik">Statistik
							Altklausur</a></li>
					<li><a href="../jsp/PortalAppl.jsp?Stat=Statistik">Statistik
					...
					<li><a href="../jsp/PortalAppl.jsp?Prog2=Prog II">Prog II
							Skript</a></li>
					<li><a href="../jsp/PortalAppl.jsp?Prog2=Prog II">Prog II
							Altklausur</a></li>
					<li><a href="../jsp/PortalAppl.jsp?Prog2=Prog II">Prog II
